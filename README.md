...
- Modo de demonstração, para testar o visual sem conectar qualquer conta.
...
- Saída selecionável em **PC 16:9 (1280 × 720)** ou **celular 9:16 (720 × 1280)**, com câmera e neblina próprias para manter o terreno inteiro enquadrado.
...
5. Escolha o formato **PC** ou **Celular** antes de iniciar. O seletor fica bloqueado enquanto o envio estiver ativo para impedir mudança de resolução no meio da transmissão.
